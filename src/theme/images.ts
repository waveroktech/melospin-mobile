export const images = {
  ...
  bg: {
    'onboarding-bg-1': require('assets/images/bg/onboarding-bg-1.png'),
    'onboarding-bg-2': require('assets/images/bg/onboarding-bg-2.png'),
  },
  'dj-images': {
    'dj-1': require('assets/images/djs/dj-1.png'),
    'dj-2': require('assets/images/djs/dj-2.png'),
  ...
  releases: {
    ...
    'release-3': require('assets/images/releases/release-3.jpeg'),
  },
